...
ADVENTURE_WORLDS = [
    ...
    {"key": "lab",    "name": "Field & Lab",   "emoji": "🔬",   "color": "#2FBFA6", "start": "l1"},
    {"key": "hustle", "name": "Hustle HQ",     "emoji": "💰",   "color": "#7BC950", "start": "h1"},
]
...
PHASE_NAMES = ["Start", "Build", "Level Up", "Showcase"]
# Every adventure runs the same 4-phase arc. Each phase is a small pool of
# assignment options; the student picks one per phase. Phase 1 is the world's
# single signature opener. subjects use exact WA_SUBJECTS so hours attribute.
ADVENTURE_NODES = [
    # ---- Maker's Forge
    {"key": "f1", "world": "forge", "phase": 1, "title": "Build a trebuchet", "icon": "\U0001FA93",
     ...
     "expects": ["Build a frame that stands on its own and holds a swinging arm",
                 ...
                 "Change one thing and test if it flies farther"],
     "deliverable": "A 30-sec video of it firing + your 3 measured distances"},
    {"key": "f2a", "world": "forge", "phase": 2, "title": "Double the distance", "icon": "\U0001F4D0",
     ...
     "expects": ["Write down your starting best distance",
                 ...
                 "Say in 2-3 sentences which change helped most and why"],
     "deliverable": "Your data table + a record that's 2x the start"},
    {"key": "f2b", "world": "forge", "phase": 2, "title": "Engineer an auto-loader", "icon": "\U0001F916",
     "subjects": "Occupational Education,Science", "hours": 3.0,
     "mission": "Add a mechanism that reloads the trebuchet without using your hands between shots.",
     ...
     "deliverable": "Your sketch + a clip of it reloading twice"},
    {"key": "f3a", "world": "forge", "phase": 3, "title": "Run a launch tournament", "icon": "\U0001F3C6",
     "subjects": "Mathematics", "hours": 2.0,
     "mission": "Hold a launch tournament against a friend or sibling with a fair scoring system.",
     "expects": ["Everyone gets the same number of throws",
                 "Design a scoring system (distance, a target, or both)",
                 "Record every score in a bracket or table",
                 "Declare a winner and explain why the scoring was fair"],
     "deliverable": "The filled-in scoreboard + who won"},
    {"key": "f3b", "world": "forge", "phase": 3, "title": "Draw the siege battle map", "icon": "\U0001F5FA️",
     "subjects": "Art & Music Appreciation,History", "hours": 2.0,
     "mission": "Research one real medieval siege and draw a labeled map of it with your trebuchet in the fight.",
     "expects": ["Base it on one real historical siege",
                 "Show the castle, the attackers, and your trebuchet",
                 "Add a key, a compass, and a rough scale",
                 "Label 3 accurate historical details"],
     "deliverable": "Your labeled battle map with the 3 details noted"},
    {"key": "f4a", "world": "forge", "phase": 4, "title": "Start a build channel", "icon": "\U0001F4FA",
     "subjects": "Writing", "hours": 3.0,
     "mission": "Film and edit a 60-second 'how I built this' video that teaches someone else to make one.",
     "expects": ["Film your trebuchet and the key build steps",
                 "Add captions or a voiceover explaining each step",
                 "Keep it under 60 seconds and easy to follow",
                 "Give your channel a name"],
     "deliverable": "The finished 60-second build video"},
    {"key": "f4b", "world": "forge", "phase": 4, "title": "Trebuchet expo night", "icon": "\U0001F399️",
     "subjects": "Science,Writing", "hours": 2.0,
     "mission": "Present your trebuchet live to family or friends and explain the physics that makes it work.",
     "expects": ["Do a live demo launch for an audience",
                 "Explain the counterweight, arm, and release out loud",
                 "Answer at least 2 questions from the audience",
                 "Write down one thing someone asked that made you think"],
     "deliverable": "A photo/clip of your demo + the question you noted"},

    # ---- Story Studio
    {"key": "s1", "world": "studio", "phase": 1, "title": "Make comic issue #1", "icon": "✏️",
     ...
     "expects": ["Plan it first: hero, problem, how it's solved",
                 "Draw 6 panels (stick figures are fine)",
                 "Put dialogue or a caption in every panel",
                 "Give it a title and a cover"],
     "deliverable": "Your 6-panel comic (photo or scan) + the cover"},
    {"key": "s2a", "world": "studio", "phase": 2, "title": "Give the hero real science", "icon": "\U0001F9EA",
     "subjects": "Science", "hours": 2.5,
     "mission": "Rewrite one of your hero's powers so it obeys real science, and explain the science.",
     "expects": ["Pick one power and name the real principle behind it",
     ...
     "deliverable": "Your science write-up + the updated panel"},
    {"key": "s2b", "world": "studio", "phase": 2, "title": "Turn it into a podcast", "icon": "\U0001F399️",
     "subjects": "Writing", "hours": 3.0,
     "mission": "Turn your comic's story into a 3-5 minute audio drama you perform and record.",
     "expects": ["Write a script with narration and character voices",
                 "Add at least 2 sound effects",
                 "Record it clearly enough to understand every line",
                 "Keep it between 3 and 5 minutes"],
     "deliverable": "The recorded audio + your script"},
    {"key": "s3a", "world": "studio", "phase": 3, "title": "Score a theme song", "icon": "\U0001F3B5",
     "subjects": "Art & Music Appreciation", "hours": 2.0,
     "mission": "Compose a 15-30 second theme that matches your hero's vibe.",
     ...
     "deliverable": "The recorded theme + one line on why it fits"},
    {"key": "s3b", "world": "studio", "phase": 3, "title": "Design the sequel cover", "icon": "\U0001F5BC️",
     "subjects": "Art & Music Appreciation,Writing", "hours": 2.0,
     "mission": "Design the cover for issue #2 and write the one-paragraph teaser for what happens next.",
     "expects": ["Design a cover that grabs attention",
                 "Show how the hero has changed since issue #1",
                 "Write a 3-4 sentence teaser for the next story",
                 "Add a title and issue number"],
     "deliverable": "Your issue #2 cover + the teaser paragraph"},
    {"key": "s4a", "world": "studio", "phase": 4, "title": "Sell prints (do the money math)", "icon": "\U0001F9EE",
     "subjects": "Occupational Education,Mathematics", "hours": 2.5,
     "mission": "Turn your comic into a product: cost it, price it, and figure out the profit on a run of 25.",
     "expects": ["Work out what one print costs to make",
                 "Set a price and find profit per print",
                 "Calculate profit if all 25 sell, and if only half do",
                 "Design a small flyer advertising it"],
     "deliverable": "Your cost/price/profit table + the flyer"},
    {"key": "s4b", "world": "studio", "phase": 4, "title": "Comic reading night", "icon": "\U0001F3A4",
     "subjects": "Writing", "hours": 2.0,
     "mission": "Perform your comic out loud for an audience - voices, drama, the works.",
     "expects": ["Practice reading it with real character voices",
                 "Read it live to at least 2 people",
                 "Add one dramatic pause or sound effect",
                 "Ask your audience what their favorite moment was"],
     "deliverable": "A recording or a photo of your reading + the feedback"},

    # ---- Field & Lab
    {"key": "l1", "world": "lab", "phase": 1, "title": "Survey a pond", "icon": "\U0001F438",
     "subjects": "Science", "hours": 3.0,
     "mission": "Study one small spot of water (pond, creek, puddle, even a jar) over two weeks.",
     "expects": ["Observe one spot 4+ times over 2 weeks",
                 "Each visit: note weather, water, and any life you see",
                 "Take a photo or sketch each time",
                 "Write down one question you can't answer yet"],
     "deliverable": "Your 4 dated observations with photos or sketches"},
    {"key": "l2a", "world": "lab", "phase": 2, "title": "Graph the data", "icon": "\U0001F4CA",
     "subjects": "Mathematics", "hours": 2.0,
    ...
    {"key": "l2b", "world": "lab", "phase": 2, "title": "Keep a field journal", "icon": "\U0001F4D3",
     "subjects": "Writing,Art & Music Appreciation", "hours": 3.0,
     "mission": "Turn your observations into a naturalist's field journal, the way real scientists do.",
     ...
     "deliverable": "Your finished multi-page field journal"},
    {"key": "l3a", "world": "lab", "phase": 3, "title": "Predict and check", "icon": "\U0001F52E",
     "subjects": "Science,Mathematics", "hours": 2.0,
     "mission": "Use your data to predict what the pond looks like next week, then go check.",
     "expects": ["Write a specific prediction based on your trend",
                 "Explain your reasoning using your data",
                 "Observe again after a week",
                 "Compare: were you right? Why or why not?"],
     "deliverable": "Your written prediction + the follow-up check"},
    {"key": "l3b", "world": "lab", "phase": 3, "title": "Compare two spots", "icon": "\U0001F50D",
     "subjects": "Science", "hours": 2.5,
     "mission": "Survey a second, different spot of water and compare what lives there to your first.",
     "expects": ["Pick a clearly different second spot",
                 "Record the same measurements you took at the first",
                 "List 3 differences between the two spots",
                 "Give one reason each spot might be different"],
     "deliverable": "Your second-spot notes + the 3 differences"},
    {"key": "l4a", "world": "lab", "phase": 4, "title": "Make a field-guide zine", "icon": "\U0001F4D6",
     "subjects": "Writing,Art & Music Appreciation", "hours": 3.0,
     "mission": "Turn everything you found into a little printed field-guide zine someone else could use.",
     "expects": ["Include a page for each thing you discovered",
                 "Add a labeled drawing and a fact for each",
                 "Write a short intro to your water spot",
                 "Fold or staple it into a real booklet"],
     "deliverable": "Your finished field-guide zine"},
    {"key": "l4b", "world": "lab", "phase": 4, "title": "Give a nature talk", "icon": "\U0001F3A4",
     "subjects": "Science,Writing", "hours": 2.0,
     "mission": "Present what you learned about your water spot to family or friends.",
     "expects": ["Plan a 3-5 minute talk with your photos or sketches",
                 "Share your biggest surprise finding",
                 "Explain one thing that changed over the two weeks",
                 "Take at least 2 questions from your audience"],
     "deliverable": "Your talk notes/slides + a photo of you presenting"},

    # ---- Hustle HQ
    {"key": "h1", "world": "hustle", "phase": 1, "title": "Launch a micro-business", "icon": "\U0001F9C3",
     "subjects": "Occupational Education", "hours": 4.0,
     "mission": "Start a tiny real business - something people will pay for - and make your first sale.",
     ...
     "deliverable": "Proof of your first sale + cost vs. what you charged"},
    {"key": "h2a", "world": "hustle", "phase": 2, "title": "Keep real books", "icon": "\U0001F9EE",
    ...
    {"key": "h2b", "world": "hustle", "phase": 2, "title": "Make an ad", "icon": "\U0001F4F8",
     "subjects": "Art & Music Appreciation", "hours": 2.0,
     ...
     "expects": ["Include what it is, why it's good, and the price",
                 "Make it eye-catching with color and a picture or logo",
                 "Write one catchy slogan",
                 "Show it to 3 people and note their reactions"],
     "deliverable": "Your finished ad + what the 3 people said"},
    {"key": "h3a", "world": "hustle", "phase": 3, "title": "Plan to scale 10x", "icon": "\U0001F4C8",
     "subjects": "Occupational Education", "hours": 2.0,
     "mission": "Make a plan for how you'd grow the business ten times bigger.",
     ...
     "deliverable": "Your 1-page growth plan"},
    {"key": "h3b", "world": "hustle", "phase": 3, "title": "Add a second product", "icon": "\U0001F195",
     "subjects": "Occupational Education,Mathematics", "hours": 2.5,
     "mission": "Design a second thing to sell that fits your business, and price it.",
     "expects": ["Pick a product that pairs with your first",
                 "Work out its cost and set a price",
                 "Make at least one to show",
                 "Predict which product will sell better and why"],
     "deliverable": "Your second product + its cost/price and your prediction"},
    {"key": "h4a", "world": "hustle", "phase": 4, "title": "Live pitch (shark tank)", "icon": "\U0001F5E3️",
     "subjects": "Writing", "hours": 2.0,
     ...
     "deliverable": "A recording of your pitch, or a witness who saw it"},
    {"key": "h4b", "world": "hustle", "phase": 4, "title": "Run a launch day", "icon": "\U0001F389",
     "subjects": "Occupational Education,Mathematics", "hours": 2.5,
     "mission": "Hold a real launch-day sale event and tally how it went.",
     "expects": ["Pick a date and tell people it's happening",
                 "Track how many you sold and your total money",
                 "Compare it to a normal day",
                 "Write down one thing you'd do differently next time"],
     "deliverable": "Your launch-day sales tally + your one takeaway"},
]
...
def get_conn():
    ...
    conn.execute("""CREATE TABLE IF NOT EXISTS adventure_nodes (
        ...
        est_hours REAL DEFAULT 2.0, branches TEXT, phase INTEGER DEFAULT 1,
        sort_order INTEGER DEFAULT 0, active INTEGER DEFAULT 1)""")
    if "phase" not in table_columns(conn, "adventure_nodes"):
        conn.execute("ALTER TABLE adventure_nodes ADD COLUMN phase INTEGER DEFAULT 1")
    ...
    # Passion Track adventures (v2 = the 4-phase model). Cleared and reseeded
    # once so existing single-branch data is replaced; guarded by its own flag
    # so a parent's later edits stick.
    if not conn.execute("SELECT value FROM settings WHERE key = ?",
                        ("adventures_v2",)).fetchone():
        conn.execute("DELETE FROM student_fun_projects WHERE world_key IS NOT NULL")
        conn.execute("DELETE FROM adventure_nodes")
        conn.execute("DELETE FROM adventure_worlds")
        ...
        for i, n in enumerate(ADVENTURE_NODES):
            conn.execute("""INSERT INTO adventure_nodes
                (node_key, world_key, title, icon, subjects, mission, expectations,
                 deliverable, est_hours, branches, phase, sort_order)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, '[]', ?, ?)""",
...
def get_adventure_node(node_key):
    ...
    r = conn.execute(
        ...
        "deliverable, est_hours, branches, phase FROM adventure_nodes WHERE node_key = ?",
        (node_key,)).fetchone()
    if not r:
        return None
    keys = ["node_key", "world_key", "title", "icon", "subjects", "mission",
            "expectations", "deliverable", "est_hours", "branches", "phase"]
    d = dict(zip(keys, r))
...
def get_adventure_phase_nodes(world_key, phase):
    """All active assignment options in one world at one phase (the pool the
    student chooses from for that phase)."""
    rows = conn.execute(
        "SELECT node_key FROM adventure_nodes WHERE world_key = ? AND phase = ? "
        "AND active = 1 ORDER BY sort_order", (world_key, phase)).fetchall()
    return [get_adventure_node(r[0]) for r in rows]
